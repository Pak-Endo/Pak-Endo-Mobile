...
class ForgetPassword extends StatelessWidget {
              ...
              child: Center(
                  child: Column(
                    ...
                    const Padding(
                        ...
                        child: Text(
                            "Enter Registered Email where you can get password reset link",
                            style: TextStyle(color: Colors.white))),
                    const SizedBox(height: 3),
                    Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: customfield(
                            'Enter Registered Email', _emailController)),
                    const SizedBox(height: 10),
                    Padding(
                        padding: const EdgeInsets.all(8.0),
  ...
  Widget custombutton(String text) {
    return GestureDetector(
        onTap: () async {
          await controller.sendResetLink(_emailController.text);
        },
        child: Container(
